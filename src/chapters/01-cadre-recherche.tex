...
La figure~\ref{fig:gantt-realisation} synth\'etise le d\'eroulement du projet
par semaines indicatives. Le d\'eveloppement du tableau de bord a commenc\'e
apr\`es les premi\`eres exp\'erimentations, puis s'est poursuivi en parall\`ele
de la recherche et de l'int\'egration de l'API. Les phases se chevauchent:
elles repr\'esentent les principales p\'eriodes de travail et non des dur\'ees
exactes d\'eduites des dates de commit.
...
\begin{figure}[htbp]
  ...
  \begin{ganttchart}[
      ...
      y unit title=0.65cm,
      y unit chart=0.78cm,
      vgrid={draw=SoftRule!65},
      hgrid=false,
      title/.style={draw=none,fill=EmeraldMist},
      title label font=\small\bfseries\color{PremiumEmerald},
      bar/.append style={draw=PremiumEmerald,fill=Emerald!78,rounded corners=1.2pt},
      bar height=0.48,
      bar label font=\small\color{Charcoal},
      bar label node/.append style={align=right,text width=4.5cm},
    ...
    \gantttitle{S4}{1}
    \gantttitle{S5}{1} \\
    \ganttbar{Recherche et essais}{1}{3} \\
    \ganttbar{Tableau de bord}{2}{5} \\
    \ganttbar{API et mod\`eles}{2}{4} \\
    \ganttbar{Ingestion et s\'ecurit\'e}{3}{4} \\
    \ganttbar{Ergonomie et supervision}{4}{5} \\
    \ganttbar{Laboratoire r\'eseau isol\'e}{5}{5}
  \end{ganttchart}
  \caption{Phases indicatives de r\'ealisation et chevauchement des travaux}
