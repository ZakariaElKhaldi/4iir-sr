...
L'analyse porte sur le fichier CSV officiel, dont l'intégrité est vérifiée
par une empreinte SHA-256. L'examen de ce fichier confirme 123\,117 lignes,
83 variables explicatives et douze
...
Ces mesures permettent d'examiner à la fois les attaques manquées et les
fausses alertes, en tenant compte de l'effectif de chaque classe
...
Le chapitre~\ref{chap:realisation} présente les écrans qui permettent de
consulter ces résultats et d'examiner les alertes.

\section{D\'emarche de recherche}

\subsection{Mode de d\'eveloppement}

Le travail a commencé par l'étude de RT-IoT2022 et par des essais de
classification. Le développement du tableau de bord a ensuite débuté alors
que les expérimentations se poursuivaient. L'historique Git montre des
évolutions successives de l'API, de l'interface, de l'ingestion et de
l'authentification, accompagnées de tests. La réalisation a ainsi progressé
par ajustements entre ces différentes parties.

Les contrats de donn\'ees ont servi de point de liaison entre les mod\`eles,
l'API et l'interface. Les tests ont ensuite accompagn\'e les changements les
plus sensibles, notamment l'ingestion, l'authentification et la persistance.
L'historique Git et les rapports d'ex\'ecution permettent de retrouver les
principales \'etapes de cette progression.
...
\begin{enumerate}
  ...
  \item pr\'eparation reproductible des donn\'ees et d\'efinition du protocole
        d'\'evaluation;
  \item comparaison des modèles, calibration, analyse des erreurs et
        enregistrement des modèles retenus pour l'application;
  ...
  \item tests unitaires, tests d'int\'egration, validation des artefacts et
        conservation des résultats et des journaux d'exécution;
...
Les modèles enregistrés sont accompagnés de leurs paramètres et des résultats
d'évaluation. Les journaux de tests complètent ces fichiers en décrivant les
vérifications de l'application. Les résultats expérimentaux sont analysés au
