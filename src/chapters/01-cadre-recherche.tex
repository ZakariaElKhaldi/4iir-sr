...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}lr@{}}
    \toprule
    \textbf{Propri\'et\'e v\'erifi\'ee} & \textbf{Valeur observ\'ee} \\
    \midrule
...
La figure~\ref{fig:application-model-analysis} montre la vue d'analyse des
mod\`eles telle qu'elle est rendue pendant les essais de bout en bout. Elle
affiche explicitement le caract\`ere hors ligne de l'\'evaluation et ne la
pr\'esente pas comme une validation de d\'eploiement.

\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{assets/screenshots/application-model-analysis.png}
  \caption{Vue d'analyse des mod\`eles captur\'ee pendant les tests Playwright de l'application}
  \label{fig:application-model-analysis}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \resizebox{\textwidth}{!}{%
    \begin{ganttchart}[
      ...
      hgrid,
      vgrid,
      title/.append style={fill=PremiumEmerald,text=white},
      title label font=\bfseries\small\color{white},
      bar/.append style={fill=Emerald!78},
      bar label font=\small
    ]{2026-07-23}{2026-08-25}
      \gantttitlecalendar{month=name} \\
      \ganttbar{Foundations and experiments}{2026-07-23}{2026-08-04} \\
      \ganttbar{API and dashboard}{2026-08-04}{2026-08-05} \\
      \ganttbar{Ingestion, authentication, and security}{2026-08-07}{2026-08-11} \\
      \ganttbar{User experience and operations}{2026-08-11}{2026-08-21} \\
      \ganttbar{Isolated network laboratory}{2026-08-20}{2026-08-21} \\
      \ganttbar{Evidence package and executed notebook}{2026-08-24}{2026-08-25}
    \end{ganttchart}%
  }
